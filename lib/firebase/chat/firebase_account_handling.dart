...
class FirebaseAccountHandling{
  ...
  static Future<void> addChatUserToMyContact(BuildContext context, String contact) async {
    // String properContact = '';
    // also user [] to get index value in string
    // properContact[3];
    // subString is used to get string value from first index to end index your entered
    //properContact.substring(0, 9);
    // if(contact.substring(0, 1) == '3') {
    //   properContact = '+${'92'}$contact';
    // }else if(contact.substring(0, 1) == '0') {
    //   properContact = '+${'92'}${contact.substring(1, )}';
    // }else {
    //   properContact = contact;
    // }
    await firestore.collection('users')
      ...
      //       Navigator.pop(context);
      //     }else{
      //       Get.snackbar('Chat App', 'We could\'t find your Contact');
      //     }
      //   },);
      // }
    },);
